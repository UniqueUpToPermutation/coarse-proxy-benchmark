classdef OracleRTENonSym < ProblemOracle
    ...
    properties (Constant = true)
        ...
        g_theta = (1:OracleRTENonSym.g_p) * 2 * pi / OracleRTENonSym.g_p;
        g_proxy = 1.5 * [cos(OracleRTENonSym.g_theta); sin(OracleRTENonSym.g_theta)];
    ...
    methods
        function obj = OracleRTENonSym(force_func, mu_t_func, mu_s_func)
            
            obj@ProblemOracle(OracleRTENonSym.g_n_coarse_grid_default, ...
                OracleRTENonSym.g_n_fine_grid_default);
        ...
        function [samples] = sampleFineOperators(this, sample_space, n_samples)
            ...
            for g=1:nRand
                ...
                [N, ~, param, ~] = setupparamnonsym(...
                    OracleRTENonSym.g_quadrature_points, this.m_n_fine, ...
                    OracleRTENonSym.g_proxy, musfuntmp, mutfuntmp);
...
function [result] = compute_coarse(force_func, mu_t_func, ...
    ...
    [N,xs,param,~] = setupparamnonsym(OracleRTENonSym.g_quadrature_points, ...
        nC, OracleRTENonSym.g_proxy, musfuntmp, mutfuntmp);
...
function [operator, diag_elements, fine_solution] = compute_fine(...
    ...
    [N,xs,param,mus] = setupparamnonsym(OracleRTENonSym.g_quadrature_points, ...
        nF, OracleRTENonSym.g_proxy, musfuntmp, mutfuntmp);
    ...
    opts = struct('skip', OracleRTENonSym.g_skip, 'symm', OracleRTENonSym.g_symm, ...
        'verb', OracleRTENonSym.g_verbose);
    Bfuntmp = @(i,j) Bfunnonsym(i, j, param, true);
    pxyfuntmp = @(x, slf, nbr, l, ctr) pxyfun(x, slf, nbr, l, ctr, param);
    operator2 = hifie2(Bfuntmp, xs, OracleRTENonSym.g_occ, ...
        OracleRTENonSym.g_rank_or_tol, pxyfuntmp, opts);
    ...
    operator = hifie2(musKfuntmp, xs, OracleRTENonSym.g_occ, ...
        OracleRTENonSym.g_rank_or_tol, pxyfuntmp, opts);
