...
if isfile('RTE_more_samples_all_fine_solutions.mat')
    [oracle, ss] = GuassianRTEHarderNonSymMoreSamples();
...
save result_table_RTE_more_samples2.mat result_table;
if ~b_fine_solutions_loaded
    save RTE_more_samples_all_fine_solutions.mat debug_all_fine_solutions;
end
